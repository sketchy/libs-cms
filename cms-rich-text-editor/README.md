...
How to develop / test:
- Run `yarn playground` and open `http://localhost:8081`. This loads the editor in a local iframe with a mocked Retool model (`initialValue`, `controls`) so you can iterate without Retool. Editor height follows the iframe size.
